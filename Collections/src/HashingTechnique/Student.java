...
public class Student {
	...
	@Override
	public int hashCode() {
		System.out.println("after add method ---> this method--->HashCOde in Student class");
		return Objects.hash(sMarks, sName, sQual, sid);
	}
	@Override
	public boolean equals(Object obj) {
		System.out.println("If hashcode is same then,this equals method is called in student class");
		if (this == obj)
			return true;
		if (obj == null)
			return false;
